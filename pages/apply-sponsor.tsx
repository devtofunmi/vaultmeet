...
const ApplySponsor: React.FC = () => {
  ...
  const validate = () => {
    ...
    else if (isNaN(Number(form.age)) || Number(form.age) < 18) newErrors.age = 'You must be at least 18'
      ...
      <form onSubmit={handleSubmit} noValidate className="space-y-6">
        ...
        <div>
          ...
          <input
            ...
            onChange={handleChange}
            className={`w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 ${
              errors.location ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-indigo-500'
            }`}
          />
        ...
        <div>
          ...
          <select
            ...
            onChange={handleChange}
            className={`w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 ${
              errors.sponsorType ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-indigo-500'
            }`}
          >
          ...
          {errors.sponsorType && <p className="text-red-600 text-sm mt-1">{errors.sponsorType}</p>}
        </div>
        ...
        <div>
          ...
          <input
            ...
            onChange={handleChange}
            className={`w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 ${
              errors.monthlyBudget ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-indigo-500'
            }`}
          />
          {errors.monthlyBudget && <p className="text-red-600 text-sm mt-1">{errors.monthlyBudget}</p>}
        </div>
