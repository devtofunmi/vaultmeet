...
const ApplySeeker: React.FC = () => {
  ...
  const validate = () => {
    ...
    if (!form.desiredSponsorType.trim()) newErrors.desiredSponsorType = 'Select a sponsor type'
      ...
      <form onSubmit={handleSubmit} noValidate className="space-y-6">
        ...
        <div>
          ...
          <select
            ...
            onChange={handleChange}
            className={`w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 ${
              errors.desiredSponsorType ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-indigo-500'
            }`}
          >
          ...
          {errors.desiredSponsorType && <p className="text-red-600 text-sm mt-1">{errors.desiredSponsorType}</p>}
        </div>
